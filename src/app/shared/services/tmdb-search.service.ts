...
export class TmdbSearchService {
  ...
  searchMovie(searchMetadata: { query: string }): Observable<any> {
    return this.httpClient.get(
      `${this.tmdbBaseUrl}${this.SEARCH_MOVIE_PATH}?include_adult=false&language=en-US&query=${searchMetadata.query}&api_key=${this.tmdbApiKey}`
    );
  }
}
